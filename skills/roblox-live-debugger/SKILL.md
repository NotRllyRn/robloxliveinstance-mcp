...
description: Use when inspecting or debugging an authorized live Roblox development client through the roblox-live MCP server, including runtime state, instances, properties, LocalScript or ModuleScript inspection, executor capabilities, runtime logs, watches, or diagnostic Luau execution.
---
...
Read `references/tool-guide.md` when choosing between similar tools or
constructing an eval.
